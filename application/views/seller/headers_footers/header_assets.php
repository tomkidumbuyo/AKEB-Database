...
<html lang="en" dir="ltr" ng-app="myApp">
  <head>
    ...
    <script src="<?php echo base_url()?>static/js/vendors/circle-progress.min.js"></script>
	 ...
	 <script src="<?php echo base_url()?>static/js/angular/sellerApp.js"></script>
	 ...
	 <!-- ANGULAR CONTROLLERS -->  
	  ...
	  <script src="<?php echo base_url()?>static/js/controllers/seller/home.js"></script>
